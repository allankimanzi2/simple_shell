...
printf("        DIR after processing instances of `..'\n");
...
printf("non-zero status\n");
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																			printf("        -@  on systems that support"            as a directory containing the file attriprintf("    The default is to follow symbolic links, as ifprintf("    Exit Status:\n");
